...
- (id)initWithFrame:(CGRect)frame cycleDirection:(CycleDirection)direction pictures:(NSArray *)pictureArray
{
    ...
    if(self)
    {
        //pictureArray=[NSMutableArray arrayWithObjects: [UIImage imageNamed:@"pic_gg1.jpg"],[UIImage imageNamed:@"pic_gg2.jpg"],[UIImage imageNamed:@"pic_gg3.jpg"],[UIImage imageNamed:@"pic_gg4.jpg"],nil];
        scrollFrame = frame;
...
{
    int i  = 0;
    i= self.myScrollView.contentOffset.x/self.myScrollView.frame.size.width;
